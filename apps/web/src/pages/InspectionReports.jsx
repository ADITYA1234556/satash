        ...
        <section className="bg-[#2E5C8A] text-white py-20">
          <div className="container mx-auto px-4">
            <motion.div {...fadeIn} className="max-w-4xl mx-auto text-center">
              <Home className="w-16 h-16 mx-auto mb-6 text-[#52B788]" aria-hidden="true" />
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Inspection Reports</h1>
              <p className="text-xl md:text-2xl leading-relaxed text-blue-100 mb-8">
                A nurturing, safe, and empowering home for young adults with learning disabilities and complex needs.
              </p>
              <div className="bg-[#4A90E2]/20 p-6 rounded-xl border border-[#4A90E2]/30 text-left">
                <h3 className="text-xl font-semibold mb-3 text-[#52B788]">Mission Statement & Registration</h3>
                <p className="text-blue-50 leading-relaxed">
                  Our mission is to provide exceptional, person-centred support that places the service user at the heart of everything we do. Jasmine Bungalow is fully registered with Ofsted to provide care and accommodation for young adults, ensuring the highest standards of safety, quality, and regulatory compliance in all our services.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Jasmine Bungalow is a spacious, detached property designed specifically to meet the needs of our service users. It features:
                    </p>
                    <ul className="space-y-3">
